...
public class ProductSteps extends Configuracao{
    ...
    public void seleciono_uma_cortesia_Courtesy_Car() {
        ProductPage.inputCourtesy(browser).click();
    }
